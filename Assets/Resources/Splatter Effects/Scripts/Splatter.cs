...
public class Splatter : MonoBehaviour
{
	...
	//ref to the sprites which will be used by sprites renderer
	[HideInInspector]
	public bool randomColor = true;
	//set to false when the target gives the color
	[HideInInspector]
	public Color32 splatColor;
	//color values which can be assigned by another script
	private SpriteRenderer spriteRenderer;
	//ref to sprite renderer component
...
//		spriteRenderer.sprite = sprites [Random.Range (0, sprites.Count)];
	...
	public void ApplyStyle ()
	{
		...
		} else {//when the other script has power to assign the color , this code is used
